...
// Import 'IoLogoFacebook' from 'react-icons/io' namespace
import { IoLogoFacebook } from 'react-icons/io';

// Import 'AiFillTwitterCircle' from 'react-icons/ai' namespace
import { AiFillTwitterCircle } from 'react-icons/ai';

// Import 'AiFillInstagram' from 'react-icons/ai' namespace
import { AiFillInstagram } from 'react-icons/ai';

// Import 'AiFillShop' from 'react-icons/ai' namespace
import { AiFillShop } from 'react-icons/ai';

// Import 'MdDoNotDisturb' from 'react-icons/md' namespace
                ...
                <div className="img-display">
                  <div ref={imgShowcase} className="img-showcase">
                    {product.images.map((i) => (
                      <Image src={i} className="prd_img_show" />
                    ))}
                  </div>
                </div>
                ...
                <div className="product-detail">
                  ...
                  <ul>
                    ...
                    {/* <li>
                      Whatsapp:{" "}
                      <span>
                        {/product.whatsappNumber.map((cg) => " | " + cg + " | ")}
                      </span>
                    </li> */}
                    <li>

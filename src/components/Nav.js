...
// Import icons from the 'react-icons/io' namespace
import {
  IoCloseOutline,
...
// Import icons from the 'react-icons/ri' namespace
import { RiShoppingCart2Line } from 'react-icons/ri';

// Import icons from the 'react-icons/md' namespace
import { MdSearch, MdKeyboardArrowRight } from 'react-icons/md';

// Import icons from the 'react-icons/io5' namespace
import { IoLogOutOutline } from 'react-icons/io5';

// Import the 'CgProfile' icon from the 'react-icons/cg' namespace
import { CgProfile } from 'react-icons/cg';

// Import the 'BsArrowRightShort' icon from the 'react-icons/bs' namespace
